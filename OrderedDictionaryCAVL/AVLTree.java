...
{                                                                   
   ...
   @Override
    ...
    {                                                                   
        //TODO: Left as an exercise.-> ainda so copiei o da direita e alterei as letras nos cases
        boolean grew = true;
        PathStep<K,V> lastStep = path.pop();
        AVLNode<K,V> parent = (AVLNode<K,V>) lastStep.parent;
        while ( grew && parent != null )
        {
            if ( lastStep.isLeftChild )
                ...
                {
                    case 'R':
                        this.rebalanceInsLeft(parent, path); //TODO verificar
                        grew = false;
                        break;
                    case 'E':
                        parent.setBalance('R');
                ...
                switch ( parent.getBalance() )
                {
                    ...
                    case 'E':
                        ...
                        break;
                    case 'L':
                        this.rebalanceInsRight(parent, path); //TODO verificar
                        grew = false;
                        break;
                }
            lastStep = path.pop();
